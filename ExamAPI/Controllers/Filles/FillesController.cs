...
namespace ExamAPI.Controllers.Filles
{
    ...
    public class FillesController : ControllerBase
    {
        ...
        // GET: api/Filles
        [HttpGet("GET")]
        public async Task<ActionResult<IEnumerable<ExamAPI.Models.Filles>>> GetFilles()
        {
        ...
        // GET: api/Filles/5
        [HttpGet("GETId/{id}")]
        public async Task<ActionResult<ExamAPI.Models.Filles>> GetFilles(int id)
        {
        ...
        [HttpPut("PUTId/{id}")]
        public async Task<IActionResult> PutFilles(int id, ExamAPI.Models.Filles filles)
        {
            if (id != filles.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost("POST")]
        public async Task<ActionResult<ExamAPI.Models.Filles>> PostFilles(ExamAPI.Models.Filles filles)
        {
