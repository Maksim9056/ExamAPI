...
namespace ExamAPI.Controllers.Save_results
{
    ...
    public class Save_resultsController : ControllerBase
    {
       ...
       [HttpGet("GET")]
        public async Task<ActionResult<IEnumerable<ExamAPI.Models.Save_results>>> GetSave_results()
        {
        ...
        [HttpGet("GETId/{id}")]
        public async Task<ActionResult<ExamAPI.Models.Save_results>> GetSave_results(int id)
        {
        ...
        [HttpPut("PUTId/{id}")]
        public async Task<IActionResult> PutSave_results(int id, ExamAPI.Models.Save_results save_results)
        {
        ...
        //To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost("POST")]
        public async Task<ActionResult<ExamAPI.Models.Save_results>> PostSave_results(ExamAPI.Models.Save_results save_results)
        {
