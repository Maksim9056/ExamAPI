...
namespace ExamAPI.Controllers.UserExams
{
    ...
    public class UserExamsController : ControllerBase
    {
        ...
        // GET: api/UserExams
        [HttpGet("GET")]
        public async Task<ActionResult<IEnumerable<ExamAPI.Models.UserExams>>> GetUserExams()
        {
        ...
        // GET: api/UserExams/5
        [HttpGet("GETId/{id}")]
        public async Task<ActionResult<ExamAPI.Models.UserExams>> GetUserExams(int id)
        {
        ...
        [HttpPut("PUTId/{id}")]
        public async Task<IActionResult> PutUserExams(int id, ExamAPI.Models.UserExams userExams)
        {
            if (id != userExams.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost("POST")]
        public async Task<ActionResult<ExamAPI.Models.UserExams>> PostUserExams(ExamAPI.Models.UserExams userExams)
        {
