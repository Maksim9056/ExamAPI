...
namespace ExamAPI.Controllers.QuestionAnswer
{
    ...
    public class QuestionAnswersController : ControllerBase
    {
        ...
        [HttpGet("GET")]
        public async Task<ActionResult<IEnumerable<ExamAPI.Models.QuestionAnswer>>> GetQuestionAnswer()
        {
        ...
        [HttpGet("GETId/{id}")]
        public async Task<ActionResult<ExamAPI.Models.QuestionAnswer>> GetQuestionAnswer(int id)
        {
        ...
        [HttpPut("PUTId/{id}")]
        public async Task<IActionResult> PutQuestionAnswer(int id, ExamAPI.Models.QuestionAnswer questionAnswer)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost("POST")]
        public async Task<ActionResult<ExamAPI.Models.QuestionAnswer>> PostQuestionAnswer(ExamAPI.Models.QuestionAnswer questionAnswer)
        {
