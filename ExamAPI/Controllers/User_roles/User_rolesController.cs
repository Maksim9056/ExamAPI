...
namespace ExamAPI.Controllers.User_roles
{
    ...
    public class User_rolesController : ControllerBase
    {
        ...
        // GET: api/User_roles
        [HttpGet("GET")]
        public async Task<ActionResult<IEnumerable<ExamAPI.Models.User_roles>>> GetUser_roles()
        {
        ...
        [HttpGet("GETId/{id}")]
        public async Task<ActionResult<ExamAPI.Models.User_roles>> GetUser_roles(int id)
        {
        ...
        [HttpPut("PUTId/{id}")]
        public async Task<IActionResult> PutUser_roles(int id, ExamAPI.Models.User_roles user_roles)
        {
            if (id != user_roles.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost("POST")]
        public async Task<ActionResult<ExamAPI.Models.User_roles>> PostUser_roles(ExamAPI.Models.User_roles user_roles)
        {
