...
namespace ExamAPI.Controllers.Options
{
    ...
    public class OptionsController : ControllerBase
    {
        ...
        // GET: api/Options
        [HttpGet("GET")]
        public async Task<ActionResult<IEnumerable<ExamAPI.Models.Options>>> GetOptions()
        {
        ...
        // GET: api/Options/5
        [HttpGet("GETId/{id}")]
        public async Task<ActionResult<ExamAPI.Models.Options>> GetOptions(int id)
        {
        ...
        [HttpPut("PUTId/{id}")]
        public async Task<IActionResult> PutOptions(int id, ExamAPI.Models.Options options)
        {
            if (id != options.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost("POST")]
        public async Task<ActionResult<ExamAPI.Models.Options>> PostOptions(ExamAPI.Models.Options options)
        {
